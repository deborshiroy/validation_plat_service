...
class Evaluator_flanT5:
    def __init__(self):
        try:
            ...
            self.logger.error('Exception in initializing Evaluator_flant5 class')
    ...
    def generate_answer(self, context, question):
        try:
            ...
            self.logger.error('Exception in generating answer for Evaluator_flant5 class')
            self.logger.error(traceback.format_exc())
            print(traceback.format_exc())
    ...
    def evaluate_bleu_rouge(self, candidates, references):
        try:
            ...
            self.logger.error('Exception in evaluating Rouge and Bleu scores for Evaluator_flant5 class')
            self.logger.error(traceback.format_exc())
            print(traceback.format_exc())
    ...
    def evaluate_bert_score(self, candidates, references):
        try:
            ...
            self.logger.error('Exception in evaluating Bert metrics for Evaluator_flant5 class')
            self.logger.error(traceback.format_exc())
            print(traceback.format_exc())
    ...
    def evaluate_perplexity(self, text):
        try:
            ...
            self.logger.error('Exception in evaluating perplexity for Evaluator_flant5 class')
            self.logger.error(traceback.format_exc())
            print(traceback.format_exc())
    ...
    def evaluate_all(self, response, reference):
        try:
            ...
            self.logger.error('Exception in evaluating metrics for Evaluator_flant5 class')
            self.logger.error(traceback.format_exc())
            print(traceback.format_exc())
    ...
    def evaluate_average(self, list_of_metrics):
        try:
            ...
            self.logger.error('Exception in calculating average for Evaluator_flant5 class')
            self.logger.error(traceback.format_exc())
            print(traceback.format_exc())